...
def add_signal(BACKTEST_FILE):
    
    print ("lancement prédiction ...")
    ...
    df["entry_signal"] = calibrator.predict(regressor_proba.predict_proba(X)[:, 1])
...
# add_signal("backtest_models_V3.csv")