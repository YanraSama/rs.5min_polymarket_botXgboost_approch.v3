...
#---------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if trade_took["trade"] == True:   
            ...
            if STOP_LOSS >  trade_took ["resultat"] or proba_drop > DROP_LIMIT or (trade_took["side"] == "BUY" and (trailing_stop >= yes_bid or yes_bid >= 0.98)) or (trade_took["side"] == "SELL" and (trailing_stop >= no_bid or no_bid >= 0.98)) or (restant < 30 and trade_took ["resultat"] > 0):
        ...
        if yes_ask > MIN_ASK and proba > PROBA and yes_ask < MAX_ASK and restant < LIMIT_TIME_MAX and restant > LIMIT_TIME_MIN:
        ...
        if no_ask > MIN_ASK and proba_no > PROBA and no_ask < MAX_ASK and restant < LIMIT_TIME_MAX and restant > LIMIT_TIME_MIN:
